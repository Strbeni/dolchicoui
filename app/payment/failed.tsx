// app/payment/failed.tsx  (or pages/payment/failed.tsx)
...
const PaymentFailed = () => {
  ...
  /* explicitly type query for safety */
  const { orderId, error: errorMsg } = router.query as {
    orderId?: string;
    error?: string;
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-red-50">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md text-center">
        ...
        {/* NEW: show gateway-returned error, if any */}
        {errorMsg && (
