  ...
  const fetchProducts = async () => {
    ...
    try {
        ...
        products: [
          {
            ...
            description: "A timeless and versatile 100% cotton white t-shirt...",
            price: 7499,
            discountedPrice: 299,
            discountPercent: 14,
            ageGroupStart: 10,
      ...
      if (data.success && Array.isArray(data.products)) {
        ...
        const offerType = JSON.parse(sessionStorage.getItem("currentOfferTypeFilters") || "[]") as OfferType[];
        ...
        const filtered = transformedProducts.filter((product) => {
          ...
          if (offerTag && offerType.length > 0 && offerType[0]) {
            ...
            // Price filter (use only discountedPrice)
            ...
            // Age group filter (fixed overlap logic)
            if (
        ...
        if (offerTag) {
          // Prioritize products matching offerType.tags[0]
          ...
          // Others: match remaining tags or grouping
