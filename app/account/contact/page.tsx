    ...
    return (
        <>
            ...
            <div className="flex items-center gap-3 mb-6 lg:mb-8">
                ...
                <div>
                    <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Contact Us</h1>
                    <p className="text-gray-600 mt-1 hidden lg:block">Fill out the form below and we will reply within 24 hours</p>
                </div>
            </div>
